...
class InvitationsControllerTest < ActionController::TestCase
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post :create, invitation: { is_join: @invitation.is_join, order_id: @invitation.order_id, user_id: @invitation.user_id }
    end
  ...
  test "should update invitation" do
    patch :update, id: @invitation, invitation: { is_join: @invitation.is_join, order_id: @invitation.order_id, user_id: @invitation.user_id }
    assert_redirected_to invitation_path(assigns(:invitation))
  end
